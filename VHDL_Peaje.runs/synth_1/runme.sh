...
HD_PWD='D:/Datos/Universidad/4.Cuarto/SED/trabajo/TRABAJO_VHDL/VHDL_Peaje/VHDL_Peaje.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EDGEDTCTR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EDGEDTCTR.tcl
